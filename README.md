...
- 모바일 API 클라이언트의 화면 연결, 지역 저장소의 concrete provider binding(AsyncStorage 등 실제 native storage package)과 마이그레이션 실행, 위치 권한, 현재 위치 조회
