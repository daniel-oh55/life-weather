...
- **PR #18 fallback request-plan factory** — 이 composition은 PR #18
  ...
  **아직 소비하지 않습니다.** current production은 여전히 PR #9 single request factory
  ...
  Provider는 **최대 1회** 호출됩니다. PR #16 candidate selector · PR #17 classifier · PR #18 request-plan
  factory를 하나의 orchestration으로 조립하는 wiring은 후속 PR(PR #19)의 몫이며, 그때까지 retry/fallback
  실행·live readiness 보장은 없습니다.
